...
int test_mat4(void) {
  ...
  Mat4 near_far = mat4Perspective(2.5f, 40.0f, 1.6f, 60.0f);
  TEST_ASSERT_FLOAT_EQ(2.5f, mat4NearFromProjection(near_far), 0.001f);
  TEST_ASSERT_FLOAT_EQ(40.0f, mat4FarFromProjection(near_far), 0.01f);
